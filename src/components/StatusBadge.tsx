...
import { CheckCircle2, AlertTriangle, XCircle, Clock, Pause, Loader2, type LucideIcon } from "lucide-react";

export type StatusType = "healthy" | "warning" | "critical" | "pending" | "paused" | "running" | "idle" | "offline";
